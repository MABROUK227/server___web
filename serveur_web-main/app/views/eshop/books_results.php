								...
								<div class="single-products">
									...
									<div class="product-overlay">
										<div class="overlay-content">
												...
												<p class="de_all" > <span style="font-size: 20px;" class="det">nom:</span><span style="color: red;font-size: 20px;"><?php if(isset($_GET['prod_result'])){echo $data['user_search'][$i]->title;} else{echo   $data['prod_data'][$i]->title;}?></span></p>

											<p class="deteils"  > <span style="font-size: 20px;" class="det">createur:</span><span style="color: red;font-size: 20px;"><?php if(isset($_GET['prod_result'])){echo $data['user_search'][$i]->author;} else{echo   $data['prod_data'][$i]->author;}?></span></p>
